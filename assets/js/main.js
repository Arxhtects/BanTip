...
$(document).ready(function() {
    ...
    $(".switch").on("click", function() {
        ...
        if($(this).hasClass("active")) {
            ...
            browser.storage.local.set({ [dataSource] : "off" }, function(){ 
                console.log('removed');
            });
        } else {
            $(this).addClass("active");
            $("body").addClass(dataSource);
            browser.storage.local.set({ [dataSource] : "on" }, function(){ 
                console.log('saved');
            });
        }
    });
    ...
    browser.storage.local.get(/* String or Array */["dark_mode"], function(items){
    ...
    browser.storage.local.get(/* String or Array */["auto_tip"], function(items){
